...
import { ModalBody, ModalHeader, ModalRoot, openModal } from "moon-ui";
...
export function startPlugin(pluginId: string) {
  ...
  const pluginString = `moon=>{return ${data.js}}${atob("Ci8v")}# sourceURL=s://!MOON/${pluginId}`;

  try {
    // noinspection CommaExpressionJS
    const rawPlugin: EvaledPlugin = (0, eval)(pluginString)(moonPluginEdition);
